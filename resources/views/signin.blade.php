    ...
    <body>
        <nav>
            <div class="up">
                ...
                <div class="logo">
                    <img src="{{ asset('img/logo.png') }}" style="height: 35px; width: 35px; margin-top: 25px; margin-right: 20px;">
                    <a href={{"index"}}>
                        <h1>FeriWala</h1>
            ...
            <div class="signinpage">
                    ...
                    <div class="bluepart">
                        ...
                        <img src="{{ asset('img/logo.png') }}" style="height: 110px; width: 140px; margin-top: 90px;">
                    </div>
                    <div class="whitepart">
                        <div class="form">
                            <!--Html form-->
                            
                            <form action={{"/psignin"}}   method="GET" >
                                ...
                                <span id="errorpassword" style="color: red; font-size: 15px; font-family:fantasy;"></span>
                                 ...
                                 <br><br>
                                <h4>By continuing, you agree to FeriWala's <span>Terms of Use</span> and <span>Privacy Policy.</span></h4>
                                <button class="submit" type="submit">Login</button>
                                
                                <div class="newuser"><a onclick="togglePopup()">New to FeriWala? Create an account</a></div>
                                <br>
                                <br>
                                <h2 style="color:red">*input valid email and password</h2>
...
<script type="text/javascript">
    const scriptURL = 'https://script.google.com/macros/s/AKfycbzRU5PAOZ89xQvW_BQXkQiLRr7Bq1Fd7lwrc2TAKbCEYDKTwhOu7frNI1_xJ4R5mr3FqA/exec'
const form = document.forms['login_form_googlesheet']

form.addEventListener('submit', e => {
 e.preventDefault()
 fetch(scriptURL, { method: 'POST', body: new FormData(form)})
   .then(response => alert("You are logged in !!"))
